      ...
      >
        ...
        >
          <motion.div variants={itemVariants} className="mb-10">
            <img src="/FONDO%20OSCURO.png" alt="Solno Logo" className="h-24 w-auto object-contain drop-shadow-[0_0_15px_rgba(204,255,0,0.3)]" />
          </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-10 text-center lg:text-left">
            <div className="flex justify-center lg:hidden mb-8">
              <img src="/FONDO%20OSCURO.png" alt="Solno Logo" className="h-16 w-auto object-contain drop-shadow-[0_0_15px_rgba(204,255,0,0.3)]" />
            </div>
