...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-background font-sans text-foreground">
      ...
      >
        <div className="flex items-center justify-center h-20 px-6 border-b border-white/5 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-center relative z-10 w-full h-full py-1">
            <img src="/FONDO%20OSCURO.png" alt="Solno Logo" className="h-full w-auto object-contain max-h-[48px]" />
          </div>
